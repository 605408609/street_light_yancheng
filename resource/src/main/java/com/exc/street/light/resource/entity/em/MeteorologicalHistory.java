/**
 * @filename:MeteorologicalHistory 2020-03-21
 * @project em  V1.0
...
public class MeteorologicalHistory extends Model<MeteorologicalHistory> {

	private static final long serialVersionUID = 1584772749293L;
	
	@TableId(value = "id", type = IdType.AUTO)
	@ApiModelProperty(name = "id" , value = "历史数据表id，自增")
	private Integer id;
