/**
 * @filename:LampEnergyDay 2020-03-28
 * @project sl  V1.0
...
public class LampEnergyDay extends Model<LampEnergyDay> {

	private static final long serialVersionUID = 1585384411272L;
	
	@TableId(value = "id", type = IdType.AUTO)
	@ApiModelProperty(name = "id" , value = "灯具每日能耗表id，自增")
	private Integer id;
	...
	/*@ApiModelProperty(name = "energyTime" , value = "能耗日期")
