/**
 * @filename:LampStrategyActionHistory 2020-03-23
 * @project sl  V1.0
...
public class LampStrategyActionHistory extends Model<LampStrategyActionHistory> {

	private static final long serialVersionUID = 1584946387268L;
