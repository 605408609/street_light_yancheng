/**
 * @filename:WifiApHistory 2020-04-30
 * @project wifi  V1.0
...
public class WifiApHistory extends Model<WifiApHistory> {

	private static final long serialVersionUID = 1588210091665L;
	...
	@ApiModelProperty(name = "upFlow" , value = "上行流量")
	private Integer upFlow;
    
	@ApiModelProperty(name = "downFlow" , value = "下行流量")
