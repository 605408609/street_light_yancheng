...
public class SlControlSystemDeviceVO extends Model<SlControlSystemDeviceVO> {
	...
	@ApiModelProperty(name = "strategyHistoryId" , value = "策略历史id")
	private Integer strategyHistoryId;
	...
	@ApiModelProperty(name = "brightness" , value = "亮度")
	private Integer brightness;

	@ApiModelProperty(name = "loopNum" , value = "支路数")
	private String loopNum;

	@ApiModelProperty(name = "locationControlNum" , value = "集中控制器编号")
	private String locationControlNum;
