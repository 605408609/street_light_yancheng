...
public class WebMvcConfigurer extends WebMvcConfigurerAdapter {
    ...
    public void addResourceHandlers(ResourceHandlerRegistry registry) {
        registry.addResourceHandler("/**").addResourceLocations("file:" + pathApi.getUpload().substring(0,pathApi.getUpload().indexOf("orderPicture")),
                "file:" + pathApi.getFile().substring(0,pathApi.getFile().indexOf("orderPicture")));
        // 开放swagger静态资源访问
