...
@Component
public class LoraNewMessageGeneration {

    private static RedisUtil redisUtil;

    @Autowired
    public void redisUtil(RedisUtil redisUtil){
        LoraNewMessageGeneration.redisUtil = redisUtil;
    }

    private static final Logger logger = LoggerFactory.getLogger(LoraNewMessageGeneration.class);
     ...
     * @return
     */
    public static String loraNewLongitudeAndLatitude(String longitude, String latitude) {
        String DR = "10";
        String ADD = "2014";
        String LENGTH = "04";
        String INFO = "";
     ...
     * @return
     */
    public static String loraNewIpMessage( String ip) {
        String DR = "10";
        String ADD = "2010";
        String LENGTH = "03";
     ...
     * 生成ota包信息
     */
    public static List<String> loraNewOta(List<String> messageInfoList){
     ...
     * @return
     */
    public static String loraNewOtaReady(String ADD,String INFO) {
        String DR = "06";
        String LENGTH = "";
     ...
     * @return
     */
    public static String loraNewOtaSize(String INFO) {
        String ADD = "200C";
        String DR = "06";
        String LENGTH = "";
        return MessageOperationUtil.generateMessage("00000000", DR, ADD, LENGTH, INFO);
     ...
     * @return
     */
    public static String loraNewOtaSendEnd(String INFO) {
        String ADD = "1008";
        String DR = "06";
        String LENGTH = "";
        return MessageOperationUtil.generateMessage("00000000", DR, ADD, LENGTH, INFO);
     ...
     * @return
     */
    public static String loraNewGetTime() {
        //生成读取当前亮度报文
        String DR = "03";
        String ADD = "1003";
        String LENGTH = "03";
     ...
     * @return
     */
    public static String loraNewReadBrightness() {
        //生成读取当前亮度报文
        String DR = "03";
        String ADD = "1002";
        String LENGTH = "01";
     ...
     * @return
     */
    public static String loraNewTurnOnLight( int brightness) {
        String DR = "10";
        String ADD = "1001";
        String LENGTH = "02";
     ...
     * @return
     */
    public static String loraNewTurnOffLight() {
        String DR = "06";
        String ADD = "1001";
        String LENGTH = "";
        String INFO = "0000";
     ...
     * @return
     */
    public static String loraNewSingleLampControl( int brightness, String state,Integer routesNum) {
        if (brightness == 0) {
            state = "00";
        }
        String DR = "10";
     ...
     * @return
     */
    public static String loraNewSingleLampControl( int brightnessOne, String stateOne , int brightnessTwo, String stateTwo) {
        if (brightnessOne == 0) {
            stateOne = "00";
        }
        if (brightnessTwo == 0) {
     ...
     * @return
     */
    public static String loraNewAdjustBrightness( int brightness) {
        //判断调整的亮度是否为0
        String message = "";
        //生成关灯和调整灯光的报文
        String DR = "06";
     ...
     * @return
     */
    public static String loraNewSetParam( int param, WithParamMatch withParamMatch) {
     ...
     * @return
     */
    public static String loraNewTiltAngle(int tiltAngle) {
        String ADD = "200F";
        String DR = "06";
        String LENGTH = "";
     ...
     * @return
     */
    public static String loraNewNoParam( NoParamMatch noParamMatch) {
     ...
     * @return
     */
    public static List<String> loraNewDailySchedule2( List<LampStrategyAction> lampStrategyActionList) {
        ...
        for (int i = 0; i < packageSize; i++) {
            ...
            for (int j = 0; j < schedulesNum[i]; j++) {
                ...
                if (lampStrategyAction != null) {
                    //场景值
                    INFO = INFO + scene;
                    INFO = INFO + loraNewScheduleInfo(lampStrategyAction);
                }
            }
            //生成报文
            String DR = "10";
     ...
     * @return
     */
    public static List<String> loraNewDailySchedule(List<Integer> loopNums, List<LampStrategyAction> lampStrategyActionList,Integer scene,List<Integer> strategyHistoryIdList) {
        ...
        for (int i = 0; i < packageSize; i++) {
            ...
            for (int j = 0; j < schedulesNum[i]; j++) {
                ...
                if (lampStrategyAction != null) {
                    ...
                    INFO = INFO + loraNewScheduleInfo(loopNums,lampStrategyAction);
                }
            }
            //生成报文
            String DR = "10";
     ...
     * @return
     */
    public static List<String> loraNewDailySchedule( List<LampStrategyAction> lampStrategyActionList) {
     ...
     * @return
     */
    public static String loraNewScheduleInfo(LampStrategyAction lampStrategyAction) {
     ...
     * @return
     */
    public static String loraNewScheduleInfo(List<Integer> loopNums,LampStrategyAction lampStrategyAction) {
     ...
     * @return
     */
    public static String loraNewScheduleInfo(LampStrategyActionHistory lampStrategyActionHistory){
        String scheduleInfo = "";
        //执行模式
