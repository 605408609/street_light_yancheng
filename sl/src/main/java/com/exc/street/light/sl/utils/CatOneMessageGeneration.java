...
@Component
public class CatOneMessageGeneration {

    private static RedisUtil redisUtil;

    @Autowired
    public void redisUtil(RedisUtil redisUtil){
        CatOneMessageGeneration.redisUtil = redisUtil;
    }

    private static final Logger logger = LoggerFactory.getLogger(CatOneMessageGeneration.class);
     ...
     * @return
     */
    public static String catOneLongitudeAndLatitude(String ADR, String longitude, String latitude) {
        String DR = "10";
        String ADD = "2014";
        String LENGTH = "04";
        String INFO = "";
     ...
     * @return
     */
    public static String catOneIpMessage(String ADR, String ip) {
        String DR = "10";
        String ADD = "2010";
        String LENGTH = "03";
     ...
     * 生成ota包信息
     */
    public static List<String> catOneOta(String ADR,List<String> messageInfoList){
     ...
     * @return
     */
    public static String catOneOtaReady(String ADD,String ADR,String INFO) {
        String DR = "06";
        String LENGTH = "";
     ...
     * @return
     */
    public static String catOneOtaSize(String ADR,String INFO) {
        String ADD = "200C";
        String DR = "06";
        String LENGTH = "";
        return MessageOperationUtil.generateMessage(ADR, DR, ADD, LENGTH, INFO);
     ...
     * @return
     */
    public static String catOneOtaSendEnd(String ADR,String INFO) {
        String ADD = "1008";
        String DR = "06";
        String LENGTH = "";
        return MessageOperationUtil.generateMessage(ADR, DR, ADD, LENGTH, INFO);
     ...
     * @return
     */
    public static String catOneGetTime(String ADR) {
        //生成读取当前亮度报文
        String DR = "03";
        String ADD = "1003";
        String LENGTH = "03";
     ...
     * @return
     */
    public static String catOneReadBrightness(String ADR) {
        //生成读取当前亮度报文
        String DR = "03";
        String ADD = "1002";
        String LENGTH = "01";
     ...
     * @return
     */
    public static String catOneTurnOnLight(String ADR, int brightness) {
        String DR = "10";
        String ADD = "1001";
        String LENGTH = "02";
     ...
     * @return
     */
    public static String catOneTurnOffLight(String ADR) {
        String DR = "06";
        String ADD = "1001";
        String LENGTH = "";
        String INFO = "0000";
     ...
     * @return
     */
    public static String catOneSingleLampControl(String ADR, int brightness, String state,Integer routesNum) {
        if (brightness == 0) {
            state = "00";
        }
        String DR = "10";
     ...
     * @return
     */
    public static String catOneSingleLampControl(String ADR, int brightnessOne, String stateOne , int brightnessTwo, String stateTwo) {
        if (brightnessOne == 0) {
            stateOne = "00";
        }
        if (brightnessTwo == 0) {
     ...
     * @return
     */
    public static String catOneAdjustBrightness(String ADR, int brightness) {
        //判断调整的亮度是否为0
        String message = "";
        //生成关灯和调整灯光的报文
        String DR = "06";
     ...
     * @return
     */
    public static String catOneSetParam(String ADR, int param, WithParamMatch withParamMatch) {
     ...
     * @return
     */
    public static String catOneTiltAngle(String ADR,int tiltAngle) {
        String ADD = "200F";
        String DR = "06";
        String LENGTH = "";
     ...
     * @return
     */
    public static String catOneNoParam(String ADR, NoParamMatch noParamMatch) {
     ...
     * @return
     */
    public static List<String> catOneDailySchedule2(String ADR, List<LampStrategyAction> lampStrategyActionList) {
        ...
        for (int i = 0; i < packageSize; i++) {
            ...
            for (int j = 0; j < schedulesNum[i]; j++) {
                ...
                if (lampStrategyAction != null) {
                    //场景值
                    INFO = INFO + scene;
                    INFO = INFO + catOneScheduleInfo(lampStrategyAction);
                }
            }
            //生成报文
            String DR = "10";
     ...
     * @return
     */
    public static List<String> catOneDailySchedule(List<Integer> loopNums,String ADR, List<LampStrategyAction> lampStrategyActionList,Integer scene,List<Integer> strategyHistoryIdList) {
        ...
        for (int i = 0; i < packageSize; i++) {
            ...
            for (int j = 0; j < schedulesNum[i]; j++) {
                ...
                if (lampStrategyAction != null) {
                    ...
                    INFO = INFO + catOneScheduleInfo(loopNums,lampStrategyAction);
                }
            }
            //生成报文
            String DR = "10";
     ...
     * @return
     */
    public static List<String> catOneDailySchedule(String ADR, List<LampStrategyAction> lampStrategyActionList) {
     ...
     * @return
     */
    public static String catOneScheduleInfo(LampStrategyAction lampStrategyAction) {
     ...
     * @return
     */
    public static String catOneScheduleInfo(List<Integer> loopNums,LampStrategyAction lampStrategyAction) {
     ...
     * @return
     */
    public static String catOneScheduleInfo(LampStrategyActionHistory lampStrategyActionHistory){
        String scheduleInfo = "";
        //执行模式
