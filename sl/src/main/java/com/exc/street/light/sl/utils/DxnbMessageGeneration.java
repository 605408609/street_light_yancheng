...
@Component
public class DxnbMessageGeneration {

    private static RedisUtil redisUtil;

    @Autowired
    public void redisUtil(RedisUtil redisUtil){
        DxnbMessageGeneration.redisUtil = redisUtil;
    }

    private static final Logger logger = LoggerFactory.getLogger(DxnbMessageGeneration.class);
     ...
     * @return
     */
    public static String dxnbLongitudeAndLatitude(String longitude, String latitude) {
        String DR = "10";
        String ADD = "2014";
        String LENGTH = "04";
        String INFO = "";
     ...
     * @return
     */
    public static String dxnbIpMessage(String ip) {
        String DR = "10";
        String ADD = "2010";
        String LENGTH = "03";
     ...
     * 生成ota包信息
     */
    public static List<String> dxnbOta(List<String> messageInfoList){
     ...
     * @return
     */
    public static String dxnbOtaReady(String ADD,String INFO) {
        String DR = "06";
        String LENGTH = "";
     ...
     * @return
     */
    public static String dxnbOtaSize(String INFO) {
        String ADD = "200C";
        String DR = "06";
        String LENGTH = "";
        return MessageOperationUtil.generateMessage("00000000", DR, ADD, LENGTH, INFO);
     ...
     * @return
     */
    public static String dxnbOtaSendEnd(String INFO) {
        String ADD = "1008";
        String DR = "06";
        String LENGTH = "";
        return MessageOperationUtil.generateMessage("00000000", DR, ADD, LENGTH, INFO);
     ...
     * @return
     */
    public static String dxnbGetTime() {
        //生成读取当前亮度报文
        String DR = "03";
        String ADD = "1003";
        String LENGTH = "03";
     ...
     * @return
     */
    public static String dxnbReadBrightness() {
        //生成读取当前亮度报文
        String DR = "03";
        String ADD = "1002";
        String LENGTH = "01";
     ...
     * @return
     */
    public static String dxnbTurnOnLight( int brightness) {
        String DR = "10";
        String ADD = "1001";
        String LENGTH = "02";
     ...
     * @return
     */
    public static String dxnbTurnOffLight() {
        String DR = "06";
        String ADD = "1001";
        String LENGTH = "";
        String INFO = "0000";
     ...
     * @return
     */
    public static String dxnbSingleLampControl( int brightness, String state,Integer routesNum) {
        if (brightness == 0) {
            state = "00";
        }
        String DR = "10";
     ...
     * @return
     */
    public static String dxnbSingleLampControl( int brightnessOne, String stateOne , int brightnessTwo, String stateTwo) {
        if (brightnessOne == 0) {
            stateOne = "00";
        }
        if (brightnessTwo == 0) {
     ...
     * @return
     */
    public static String dxnbAdjustBrightness( int brightness) {
        //判断调整的亮度是否为0
        String message = "";
        //生成关灯和调整灯光的报文
        String DR = "06";
     ...
     * @return
     */
    public static String dxnbSetParam(int param, WithParamMatch withParamMatch) {
     ...
     * @return
     */
    public static String dxnbTiltAngle(int tiltAngle) {
        String ADD = "200F";
        String DR = "06";
        String LENGTH = "";
     ...
     * @return
     */
    public static String dxnbNoParam( NoParamMatch noParamMatch) {
     ...
     * @return
     */
    public static List<String> dxnbDailySchedule2( List<LampStrategyAction> lampStrategyActionList) {
        ...
        for (int i = 0; i < packageSize; i++) {
            ...
            for (int j = 0; j < schedulesNum[i]; j++) {
                ...
                if (lampStrategyAction != null) {
                    //场景值
                    INFO = INFO + scene;
                    INFO = INFO + dxnbScheduleInfo(lampStrategyAction);
                }
            }
            //生成报文
            String DR = "10";
     ...
     * @return
     */
    public static List<String>  dxnbDailySchedule(List<Integer> loopNums, List<LampStrategyAction> lampStrategyActionList,Integer scene,List<Integer> strategyHistoryIdList) {
        ...
        for (int j = 0; j < size; j++) {
            ...
            if (lampStrategyAction != null) {
                ...
                INFO = INFO + dxnbScheduleInfo(loopNums,lampStrategyAction);
            }
        }
        //生成报文
        String DR = "10";
     ...
     * @return
     */
    public static List<String> dxnbDailySchedule( List<LampStrategyAction> lampStrategyActionList) {
     ...
     * @return
     */
    public static String dxnbScheduleInfo(LampStrategyAction lampStrategyAction) {
     ...
     * @return
     */
    public static String dxnbScheduleInfo(List<Integer> loopNums,LampStrategyAction lampStrategyAction) {
     ...
     * @return
     */
    public static String dxnbScheduleInfo(LampStrategyActionHistory lampStrategyActionHistory){
        String scheduleInfo = "";
        //执行模式
