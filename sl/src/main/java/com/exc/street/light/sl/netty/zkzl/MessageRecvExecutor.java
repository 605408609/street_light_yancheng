...
public class MessageRecvExecutor {
    ...
    private Map<String, Object> channelMap = new ConcurrentHashMap<String, Object>();
    private ChannelGroup channelgroup;
    private static ThreadPoolExecutor threadPoolExecutor;

    public MessageRecvExecutor(int localPort, Map<String,Object> channelMap,ChannelGroup channelgroup) {
    ...
    public void afterPropertiesSet() throws Exception {
        ...
        try {
            ...
            bootstrap.group(boss, worker)
                    ...
                    .childHandler(new MessageRecvChannelInitializer(channelMap,channelgroup))
