...
@Component
public class DxCatOneMessageGeneration {

    private static RedisUtil redisUtil;

    @Autowired
    public void redisUtil(RedisUtil redisUtil){
        DxCatOneMessageGeneration.redisUtil = redisUtil;
    }

    private static final Logger logger = LoggerFactory.getLogger(DxCatOneMessageGeneration.class);
     ...
     * @return
     */
    public static String dxCatOneLongitudeAndLatitude( String longitude, String latitude) {
        String DR = "10";
        String ADD = "2014";
        String LENGTH = "04";
        String INFO = "";
     ...
     * @return
     */
    public static String dxCatOneIpMessage( String ip) {
        String DR = "10";
        String ADD = "2010";
        String LENGTH = "03";
     ...
     * 生成ota包信息
     */
    public static List<String> dxCatOneOta(List<String> messageInfoList){
     ...
     * @return
     */
    public static String dxCatOneOtaReady(String ADD,String INFO) {
        String DR = "06";
        String LENGTH = "";
     ...
     * @return
     */
    public static String dxCatOneOtaSize(String INFO) {
        String ADD = "200C";
        String DR = "06";
        String LENGTH = "";
        return MessageOperationUtil.generateMessage("00000000", DR, ADD, LENGTH, INFO);
     ...
     * @return
     */
    public static String dxCatOneOtaSendEnd(String INFO) {
        String ADD = "1008";
        String DR = "06";
        String LENGTH = "";
        return MessageOperationUtil.generateMessage("00000000", DR, ADD, LENGTH, INFO);
     ...
     * @return
     */
    public static String dxCatOneGetTime() {
        //生成读取当前亮度报文
        String DR = "03";
        String ADD = "1003";
        String LENGTH = "03";
     ...
     * @return
     */
    public static String dxCatOneReadBrightness() {
        //生成读取当前亮度报文
        String DR = "03";
        String ADD = "1002";
        String LENGTH = "01";
     ...
     * @return
     */
    public static String dxCatOneTurnOnLight( int brightness) {
        String DR = "10";
        String ADD = "1001";
        String LENGTH = "02";
     ...
     * @return
     */
    public static String dxCatOneTurnOffLight() {
        String DR = "06";
        String ADD = "1001";
        String LENGTH = "";
        String INFO = "0000";
     ...
     * @return
     */
    public static String dxCatOneSingleLampControl( int brightness, String state,Integer routesNum) {
        if (brightness == 0) {
            state = "00";
        }
        String DR = "10";
     ...
     * @return
     */
    public static String dxCatOneSingleLampControl( int brightnessOne, String stateOne , int brightnessTwo, String stateTwo) {
        if (brightnessOne == 0) {
            stateOne = "00";
        }
        if (brightnessTwo == 0) {
     ...
     * @return
     */
    public static String dxCatOneAdjustBrightness( int brightness) {
        //判断调整的亮度是否为0
        String message = "";
        //生成关灯和调整灯光的报文
        String DR = "06";
     ...
     * @return
     */
    public static String dxCatOneSetParam( int param, WithParamMatch withParamMatch) {
     ...
     * @return
     */
    public static String dxCatOneTiltAngle(int tiltAngle) {
        String ADD = "200F";
        String DR = "06";
        String LENGTH = "";
     ...
     * @return
     */
    public static String dxCatOneNoParam( NoParamMatch noParamMatch) {
     ...
     * @return
     */
    public static List<String> dxCatOneDailySchedule2( List<LampStrategyAction> lampStrategyActionList) {
        ...
        for (int i = 0; i < packageSize; i++) {
            ...
            for (int j = 0; j < schedulesNum[i]; j++) {
                ...
                if (lampStrategyAction != null) {
                    //场景值
                    INFO = INFO + scene;
                    INFO = INFO + dxCatOneScheduleInfo(lampStrategyAction);
                }
            }
            //生成报文
            String DR = "10";
     ...
     * @return
     */
    public static List<String> dxCatOneDailySchedule(List<Integer> loopNums, List<LampStrategyAction> lampStrategyActionList,Integer scene,List<Integer> strategyHistoryIdList) {
        ...
        String INFO = prefix + HexUtil.intToHexStringOne(0);
        //当前包时间表数量（2字节）
        //INFO = INFO + HexUtil.intToHexString(schedulesNum[i]);
        INFO = INFO + HexUtil.intToHexString(size);

        /*for (int j = 0; j < schedulesNum[i]; j++) {
            LampStrategyAction lampStrategyAction = lampStrategyActionList.get(3 * i + j);*/
        for (int j = 0; j < size; j++) {
            LampStrategyAction lampStrategyAction = lampStrategyActionList.get(j);
            ...
            if (lampStrategyAction != null) {
                ...
                INFO = INFO + dxCatOneScheduleInfo(loopNums,lampStrategyAction);
            }
        }
        //生成报文
        String DR = "10";
     ...
     * @return
     */
    public static List<String> dxCatOneDailySchedule( List<LampStrategyAction> lampStrategyActionList) {
     ...
     * @return
     */
    public static String dxCatOneScheduleInfo(LampStrategyAction lampStrategyAction) {
     ...
     * @return
     */
    public static String dxCatOneScheduleInfo(List<Integer> loopNums,LampStrategyAction lampStrategyAction) {
     ...
     * @return
     */
    public static String dxCatOneScheduleInfo(LampStrategyActionHistory lampStrategyActionHistory){
        String scheduleInfo = "";
        //执行模式
