...
import com.exc.street.light.wsi.service.KafkaMessageService;
    ...
    public void processMessage(List<ConsumerRecord<?, ?>> records) throws UnsupportedEncodingException {
        ...
        for (ConsumerRecord<?, ?> record : records) {
            ...
            if(kafkaMessage.isPresent()){
                ...
                String sendMessage = JSON.toJSONString(pushMessage);
                socketIOService.pushMessage2AllClient(sendMessage);
            }
        }
