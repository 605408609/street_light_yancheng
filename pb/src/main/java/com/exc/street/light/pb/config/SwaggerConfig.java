 ...
 * All right reserved.
 */
package com.exc.street.light.pb.config;
...
public class SwaggerConfig {
	 ...
	 * Swagger扫描的接口路径
	 */
	public static String CONTROLLER_URL = "com.exc.street.light.pb.web";
	/**
	 * Swagger接口文档标题
	 */
	public static String SWAGGER_TITLE = "API文档-广播";
	/**
	 * Swagger接口文档描述
	 */
	 ...
	 * Swagger项目服务的URL
	 */
	public final static String SWAGGER_URL = "http://192.168.112.158:60022";
