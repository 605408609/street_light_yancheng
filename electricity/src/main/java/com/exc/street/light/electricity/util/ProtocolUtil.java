...
public class ProtocolUtil {
     ...
     * 周期类型设定
     *
     * @param timingType  定时类型
     * @param cycleTypes  星期选择
     * @param executeType 执行或不执行
     * @return
     */
        ...
        if (timingParameterNum > 0) {
            ...
            for (int i = 0; i < timingParameterNum; i++) {
                ...
                if (type == 1 || type == 2 || type == 3) {
                    protocols[++timerIndex] = (byte) 1;
                } else if (type == 5) {
                    protocols[++timerIndex] = (byte) 2;
                } else if (type == 6) {
                    protocols[++timerIndex] = (byte) 3;
                } else if (type == 7) {
                    protocols[++timerIndex] = (byte) 4;
                } else if (type == 8) {
                    protocols[++timerIndex] = (byte) 5;
                }
                //执行周期类型
