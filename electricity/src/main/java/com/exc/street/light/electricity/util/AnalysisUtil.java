...
public class AnalysisUtil {
    ...
    public static List<ElectricityMeterModuleDataDTO> getMeterModuleDataCommandResp(byte[] protocol) {
        ...
        for (int i = 0; i < meterDataNum; i++) {
            ...
            //当前组合有功总电能
            data.setCurrentCombinedActiveTotalEnergy(HexUtil.bytesToFloat(HexUtil.getByteArr(protocol, dataIndex, 4)));
            dataIndex += 4;
            //当前正向有功总电能
            data.setCurrentTotalPositiveActiveEnergy(HexUtil.bytesToFloat(HexUtil.getByteArr(protocol, dataIndex, 4)));
            dataIndex += 4;
            //当前反向有功总电能
            data.setCurrentTotalReverseActiveEnergy(HexUtil.bytesToFloat(HexUtil.getByteArr(protocol, dataIndex, 4)));
            dataIndex += 4;
            //当前正向无功总电能
            data.setCurrentTotalPositiveReactivePower(HexUtil.bytesToFloat(HexUtil.getByteArr(protocol, dataIndex, 4)));
            dataIndex += 4;
            //当前反向视在总电能
            data.setCurrentReverseApparentTotalEnergy(HexUtil.bytesToFloat(HexUtil.getByteArr(protocol, dataIndex, 4)));
            dataIndex += 4;
            //  A相电压
            data.setAPhaseVoltage(HexUtil.bytesToFloat(HexUtil.getByteArr(protocol, dataIndex, 4)));
            dataIndex += 4;
            //  B相电压
            data.setBPhaseVoltage(HexUtil.bytesToFloat(HexUtil.getByteArr(protocol, dataIndex, 4)));
            dataIndex += 4;
            //  C相电压
            data.setCPhaseVoltage(HexUtil.bytesToFloat(HexUtil.getByteArr(protocol, dataIndex, 4)));
            dataIndex += 4;
            //  A相电流
            data.setAPhaseCurrent(HexUtil.bytesToFloat(HexUtil.getByteArr(protocol, dataIndex, 4)));
            dataIndex += 4;
            //  B相电流
            data.setBPhaseCurrent(HexUtil.bytesToFloat(HexUtil.getByteArr(protocol, dataIndex, 4)));
            dataIndex += 4;
            //  C相电流
            data.setCPhaseCurrent(HexUtil.bytesToFloat(HexUtil.getByteArr(protocol, dataIndex, 4)));
            dataIndex += 4;
            //  A相有功功率
            data.setAPhaseActivePower(HexUtil.bytesToFloat(HexUtil.getByteArr(protocol, dataIndex, 4)));
            dataIndex += 4;
            //  A相无功功率
            data.setAPhaseReactivePower(HexUtil.bytesToFloat(HexUtil.getByteArr(protocol, dataIndex, 4)));
            dataIndex += 4;
            //  A相视在功率
            data.setAPhaseApparentPower(HexUtil.bytesToFloat(HexUtil.getByteArr(protocol, dataIndex, 4)));
            dataIndex += 4;
            //  A相功率因数字
            data.setAPhasePowerFactorNumber(HexUtil.bytesToFloat(HexUtil.getByteArr(protocol, dataIndex, 4)));
            dataIndex += 4;
            //  B相有功功率
            data.setBPhaseActivePower(HexUtil.bytesToFloat(HexUtil.getByteArr(protocol, dataIndex, 4)));
            dataIndex += 4;
            //  B相无功功率
            data.setBPhaseReactivePower(HexUtil.bytesToFloat(HexUtil.getByteArr(protocol, dataIndex, 4)));
            dataIndex += 4;
            //  B相视在功率
            data.setBPhaseApparentPower(HexUtil.bytesToFloat(HexUtil.getByteArr(protocol, dataIndex, 4)));
            dataIndex += 4;
            //  B相功率因数字
            data.setBPhasePowerFactorNumber(HexUtil.bytesToFloat(HexUtil.getByteArr(protocol, dataIndex, 4)));
            dataIndex += 4;
            //  C相有功功率
            data.setCPhaseActivePower(HexUtil.bytesToFloat(HexUtil.getByteArr(protocol, dataIndex, 4)));
            dataIndex += 4;
            //  C相无功功率
            data.setCPhaseReactivePower(HexUtil.bytesToFloat(HexUtil.getByteArr(protocol, dataIndex, 4)));
            dataIndex += 4;
            //  C相视在功率
            data.setCPhaseApparentPower(HexUtil.bytesToFloat(HexUtil.getByteArr(protocol, dataIndex, 4)));
            dataIndex += 4;
            //  C相功率因数字
            data.setCPhasePowerFactorNumber(HexUtil.bytesToFloat(HexUtil.getByteArr(protocol, dataIndex, 4)));
            dataIndex += 4;
