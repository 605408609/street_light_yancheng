...
public class ConstantUtil {
     ...
     * 在线的mac集合
     */
    public static final String ONLINE_MAC_SET = "owner:OnlineMacSet";

    /**
     * 强电网关第一个心跳包记录(hash)
     */
    public static final String FIRST_HEARTBEAT_KEY = "owner:power_first_heartbeat";

    /**
     * 强电网关心跳状态在redis的key(hash)
     */
    public static final String MAC_HEARTBEAT_STATUS_KEY = "mac_heartbeat_status";
...
//    public static final int TIMER_BASE_LENGTH = 9;
     ...
     * 类型：运维
     */
    public static final byte CONTROL_IDENTIFIER_EXC_2A = 0x2A;
    /**
     * 模块升级指令
     * 来源:自研发
     * 类型：运维
